...
CKPT_PATH="${CKPT_PATH:-hf:jdeschena/blockgen/blockgen/multi_block_size/16/owt/0.05_0.95/uniform}"
CACHE_DIR="${CACHE_DIR:-${REPO_ROOT}/data_cache}"
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/eval_runs/owt/blockgen_uniform_ar_then_arpc}"
...
# multi-block 1+16 BlockGen model. Multi-block models share the KV cache
# between the AR and diffusion paths, so they use model.x0_causal=True.
