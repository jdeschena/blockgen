...
CKPT_PATH="${CKPT_PATH:-hf:jdeschena/blockgen/blockgen/single_block_size/16/owt/absorb}"
CACHE_DIR="${CACHE_DIR:-${REPO_ROOT}/data_cache}"
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/eval_runs/owt/blockgen_absorb_block_ancestral}"
