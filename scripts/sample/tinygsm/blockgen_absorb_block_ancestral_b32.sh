...
CKPT_PATH="${CKPT_PATH:-hf:jdeschena/blockgen/blockgen/single_block_size/32/tinygsm/absorb}"
CACHE_DIR="${CACHE_DIR:-${REPO_ROOT}/data_cache}"
DATA_PATH="${DATA_PATH:-${REPO_ROOT}/data/gsm8k_test.json}"
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/eval_runs/tinygsm/blockgen_absorb_block_ancestral_b32}"
...
# Block-ancestral sampling of a masked (absorbing) single-block-32 BlockGen model.
