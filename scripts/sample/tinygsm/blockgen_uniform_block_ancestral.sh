...
CKPT_PATH="${CKPT_PATH:-hf:jdeschena/blockgen/blockgen/single_block_size/16/tinygsm/uniform}"
CACHE_DIR="${CACHE_DIR:-${REPO_ROOT}/data_cache}"
DATA_PATH="${DATA_PATH:-${REPO_ROOT}/data/gsm8k_test.json}"
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/eval_runs/tinygsm/blockgen_uniform_block_ancestral}"
