...
CKPT_PATH="${CKPT_PATH:-hf:jdeschena/blockgen/blockgen/multi_block_size/16/tinygsm/0.05_0.95/absorb}"
CACHE_DIR="${CACHE_DIR:-${REPO_ROOT}/data_cache}"
DATA_PATH="${DATA_PATH:-${REPO_ROOT}/data/gsm8k_test.json}"
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/eval_runs/tinygsm/blockgen_absorb_ar_then_arpc}"
...
# (absorbing) multi-block 1+16 BlockGen model on GSM8K -- the headline TinyGSM
