...
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/outputs/tinygsm/blockgen_absorb_1_32_w_0p01_0p99}"
NUM_NODES="${NUM_NODES:-1}"
DEVICES="${DEVICES:-8}"

cd "${REPO_ROOT}"

# Masked (absorbing) BlockGen with a 1+32 block-size mixture (1% AR / 99% diffusion).
