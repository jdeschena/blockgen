...
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/outputs/tinygsm/blockgen_absorb_1_32_w_0p05_0p95}"
NUM_NODES="${NUM_NODES:-1}"
DEVICES="${DEVICES:-8}"

cd "${REPO_ROOT}"

# Masked (absorbing) BlockGen with a 1+32 block-size mixture (5% AR / 95% diffusion).
...
python -u -m main \
    ...
    "algo.block_weights=0.05 0.0 0.0 0.0 0.0 0.95" \
